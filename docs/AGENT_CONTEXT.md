...
- **Story UI:** Ten **9:16** cards in a vertical scroller (scroll-snap, Prev/Next, dots, keyboard). Share hint: screenshot any card for Stories (no programmatic Save). Components: `WrappedPage.jsx`, `wrappedSlideContent.jsx`, `WrappedSlideChrome.jsx`, `WrappedAvatarPodium.jsx`; themes/palette/avatars in `wrappedThemes.js`, `wrappedPalette.js`, `wrappedAvatars.js`.
